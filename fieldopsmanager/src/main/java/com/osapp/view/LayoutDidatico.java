...
public class LayoutDidatico {
    ...
    public LayoutDidatico() {
        ...
        // ------------------------------  <divs no main> -------------------------------------
        VBox nav = new VBox();
        nav.setStyle("-fx-background-color: #FFA07A;"); // coral
        nav.setPadding(new Insets(10));
        nav.getChildren().add(new Label("Navegação"));

        
        VBox workspace = new VBox();
        workspace.setStyle("-fx-background-color: #98FB98;"); // palegreen
        ...
        mainContent.getChildren().addAll(nav, workspace); // posicionamento horizontal
